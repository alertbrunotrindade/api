...
from ALERT.analitics.carga_e_analiseexploratoria_tela1 import analise_exploratoria_tel1
from ALERT.analitics.coleta_das_variaveis_tela2 import variaveis_escolhidas
from ALERT.analitics.balanceamento_tela3 import rotina_balanceamento
from ALERT.analitics.coleta_cluster_tela4 import gera_cluster
from ALERT.analitics.rodar_novo_arquivo_tela5 import rodar_novo_arquivo
from ALERT.analitics.graficos.grafico_result_cluster_dispersao import grafico_result_cluster_dispersao
from ALERT.analitics.graficos.grafico_reuslt_cluster import grafico_result_cluster
from ALERT.analitics.graficos.revisao_segundo_arquivo import revisao_segundo_arquivo
from ALERT.analitics.graficos.grafico_waterfall import grafico_waterfall
from ALERT.analitics.graficos.gera_waterfall import grafico_waterfall

from ALERT.webb_cob.cob_analitics_api.api.carga_e_analise_exploratoria_tel1 import analise_exploratoria__tel1
from ALERT.webb_cob.cob_analitics_api.api.ajustedata_e_priorizar_tel2 import ajuste_e_priorizar
from ALERT.webb_cob.cob_analitics_api.api.outliers_e_cluster_tel3 import outliers_e_cluster
from ALERT.webb_cob.cob_analitics_api.api.segundo_arquivo_tel4 import analise_segundoarquivo
...
TOKEN = "akiva#340340"
UPLOAD_FOLDER = r"C:\Users\Pichau\Documents\ALERT\PROJETO_ANALI\GN_Analitycs_WEB_files\arquivos\vendas/"
UPLOAD_FOLDER_COB = r"C:\Users\Pichau\Documents\ALERT\PROJETO_ANALI\GN_Analitycs_WEB_files\arquivos\cob/"
...
def gera_result_cluster():
    ...
    return jsonify({'status': 'success', 'retorno': grafico_cluster}), 200
...
def gerar_revisao():
    ...
    return jsonify({'status': 'success', 'retorno': rev_segundo_arquivo}), 200
